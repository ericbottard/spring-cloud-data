...
import org.springframework.cloud.dataflow.server.repository.TaskJobExecution;
...
public class JobExecutionController {
	...
	private TaskJobExecutionRepository repository;
	 ...
	 */
	@Autowired
	public JobExecutionController(TaskJobExecutionRepository repository) {
	...
	private static class Assembler extends ResourceAssemblerSupport<TaskJobExecution, JobExecutionResource> {
		...
		public JobExecutionResource instantiateResource(TaskJobExecution taskJobExecution) {
			...
			JobExecutionResource jobExecutionResource = new JobExecutionResource(
					taskJobExecution.getTaskId(),
					jobExecution.getId(), jobExecution.getStatus(),
					jobExecution.getStartTime(), jobExecution.getEndTime(),
					jobExecution.getExitStatus(), jobExecution.getJobParameters(),
